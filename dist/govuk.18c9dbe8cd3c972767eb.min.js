/*! For license information please see govuk.18c9dbe8cd3c972767eb.min.js.LICENSE.txt */
(() => {
  "use strict";
  (() => {
    function t(t = document.body) {
    ...
    class i extends n {
      constructor(t) {
        ...
        super(n), (this.name = "ElementError");
      }
    }
    class r extends n {
      constructor(t) {
        super(
          "string" == typeof t
            ? t
            : e(t, "Root element (`$root`) already initialised"),
        ),
          (this.name = "InitError");
      }
    }
    function s(e, n, i) {
      ...
      var u;
      "object" == typeof i &&
        ((s = null != (u = i.scope) ? u : s), (r = i.onError)),
        "function" == typeof i && (r = i),
        i instanceof HTMLElement && (s = i);
      const c = s.querySelectorAll(`[data-module="${e.moduleName}"]`);
      return t()
        ? Array.from(c)
            .map((t) => {
              try {
                return void 0 !== n ? new e(t, n) : new e(t);
              } catch (o) {
                return (
                  r
                    ? r(o, { element: t, component: e, config: n })
                    : console.log(o),
                  null
                );
              }
            ...
            .filter(Boolean)
        : (r ? r(new o(), { component: e, config: n }) : console.log(new o()),
          []);
    }
    class u {
      get $root() {
    ...
    class c extends u {
      ...
      setupResponsiveChecks() {
        const t = (function () {
          const t = "--govuk-frontend-breakpoint-tablet";
          return {
            property: t,
            value:
              window
    ...
    c.moduleName = "govuk-service-navigation";
    class l extends u {
      constructor(t) {
        var e;
        super(t);
        ...
        try {
          ...
          throw new i(`Skip link: Target link (\`href="${o}"\`) is invalid`);
        }
        if (
...
//# sourceMappingURL=govuk.18c9dbe8cd3c972767eb.min.js.map
